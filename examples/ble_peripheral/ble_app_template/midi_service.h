...
#define BLE_UUID_MIDI_DATA_IO_CHAR_UUID 0xE5DB
    ...
    typedef struct
    {
        /* Event handler to be called when MIDI Data I/O characteristic is written. */
